...
- [AWS CLIでTrailを作成・更新する](https://docs.aws.amazon.com/ja_jp/awscloudtrail/latest/userguide/cloudtrail-create-and-update-a-trail-by-using-the-aws-cli-create-trail.html)
...
- [CloudTrail用Amazon S3バケットポリシー](https://docs.aws.amazon.com/ja_jp/awscloudtrail/latest/userguide/create-s3-bucket-policy-for-cloudtrail.html)
- [CloudTrailイベントをCloudWatch Logsへ送信する](https://docs.aws.amazon.com/ja_jp/awscloudtrail/latest/userguide/send-cloudtrail-events-to-cloudwatch-logs.html)
...
- [CloudTrailがCloudWatch Logsへ送信するためのRole Policy](https://docs.aws.amazon.com/ja_jp/awscloudtrail/latest/userguide/cw_role_policy.html)
- [CloudTrail Lake Event Data StoreをAWS CLIで管理する](https://docs.aws.amazon.com/ja_jp/awscloudtrail/latest/userguide/lake-eds-cli.html)
- [CloudTrail Lakeクエリ](https://docs.aws.amazon.com/ja_jp/awscloudtrail/latest/userguide/cloudtrail-lake-queries.html)
