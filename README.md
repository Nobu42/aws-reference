...
| 用途 | 資料 |
| :--- | :--- |
| 最新の作業計画、対象要件、スケジュール、対応不要項目を確認する | [クラウドセキュリティ対応 WBS案](./aws_security_remediation_wbs_2026_07.md) |
...
| 4.1〜4.15のCloudWatch Alarmテスト、実イベント確認、代替確認の手順を確認する | [全要件 CloudWatch Alarmテスト・確認手順](./cloudwatch_alarm_test_confirmation_procedure_all_requirements_2026_08.txt) |
| 危険度が高い要件の通知テスト、実イベント代替、テスト用リソース確認を行う | [危険度高め要件 CloudWatch Alarmテスト手順](./high_risk_cloudwatch_alarm_test_procedure_2026_08.txt) |
...
| 4.7でテスト専用CMKを使った実イベントテストと削除予約までの手順を確認する | [要件4.7 テスト専用CMK 実イベントテスト手順書](./requirements_4_7_test_cmk_event_test_runbook_2026_07.md) |
...
| Metric Filter / Alarmで使用するCloudWatch Metric Namespaceの決め方を確認する | [CloudWatch Metric Namespace 設計確認メモ](./cloudwatch_metric_namespace_decision_points_2026_07.md) |
